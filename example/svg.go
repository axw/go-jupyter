// This file is based on https://github.com/ajstarks/svgo/blob/master/svgopher/svgopher.go
//
// From LICENSE:
...
func background(canvas *svg.SVG, v int) {
	canvas.Rect(0, 0, width, height, canvas.RGB(v, v, v))
}

func gordon(canvas *svg.SVG, x, y, w, h int) {
